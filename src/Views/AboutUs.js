...
function AboutUs() {
    ...
    const one = (<div className="conteiner">
                    <div className="row" >
                        <img src={intars} alt="Intars"/>
                    </div>
    ...
    const two = (<div className="conteiner">
                    <div className="row" >
                        <img src={kate} alt="Jekaterina" />
                    </div>
                    <div className="row divRow">
    ...
    const three = (<div className="conteiner">
                    <div className="row" >
                        <img src={inga} alt="Inga"/>
                    </div>
                    <div className="row divRow">
    ...
    const four = (<div className="conteiner" >
                    <div className="row" >
                        <img src={napoleons} alt="Napoleons"/>
                    </div>
                    <div className="row divRow">
