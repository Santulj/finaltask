    ...
    return (
        <div>
            ...
            <div className="jumbotron abonentsJumptron"> 
                ...
                <p className="lead">Izvēlies sev piemērotāko Coworking Liepaja abonementu. Ja neesi līdz šim bijis pazīstams ar kopstrādes birojiem un neesi pārliecināts par savu izvēli, piesaki izmēģinājuma dienu un iepazīsti kopstrādes biroju priekšrocības</p>
                <hr className="my-4"/>
